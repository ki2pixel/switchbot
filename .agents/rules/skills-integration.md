...
**Action**: Charger `fast_read_file(".agents/skills/shrimp-task-manager/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/sequentialthinking-logic/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/fast-filesystem-ops/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/json-query-expert/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/debugging-strategies/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/add-feature/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/performance-audit-runbook/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/automation-diagnostics/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/switchbot-api-dev/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/postgres-store-maintenance/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/history-dashboard-updater/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/quota-alerting/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/loader-patterns/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/ifttt-cascade/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/scheduler-ops/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/documentation/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/render-service-manager/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/postgres-ops-manager/SKILL.md")`
...
**Action**: Charger `fast_read_file(".agents/skills/render-postgres-integration/SKILL.md")`
...
3. **Charger le skill** via `fast_read_file(".agents/skills/[skill-name]/SKILL.md")`
