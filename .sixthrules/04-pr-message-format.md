...
- This rule defines the PR message format in a way that aligns with the commit message convention based on Conventional Commits (`08-commit-message-format.md`).
...
- Determine Prefix and summary to align with the commit message convention (`08-commit-message-format.md`) (avoid semantic inconsistency between commits and PR).
