...
**Action**: Charger `fast_read_file(\".cline/skills/shrimp-task-manager/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/sequentialthinking-logic/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/fast-filesystem-ops/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/json-query-expert/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/debugging-strategies/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/add-feature/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/performance-audit-runbook/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/automation-diagnostics/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/switchbot-api-dev/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/postgres-store-maintenance/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/history-dashboard-updater/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/quota-alerting/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/loader-patterns/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/ifttt-cascade/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/scheduler-ops/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/documentation/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/render-service-manager/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/postgres-ops-manager/SKILL.md\")`
...
**Action**: Charger `fast_read_file(\".cline/skills/render-postgres-integration/SKILL.md\")`
...
3. **Charger le skill** via `fast_read_file(\".cline/skills/[skill-name]/SKILL.md\")`
