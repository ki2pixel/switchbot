Get started: Free and powerful integrations with IFTTT
======================================================

![Get started](https://web-assets.ifttt.com/builds/assets/get_started_header-ByCvufnM.png "Get started")

It's easy to work with familiar and relevant brands: from the latest bots and IoT, to the world’s most famous voice-activated assistant. As a developer, you can publish a service, build Applets, and embed them directly in your app or website, all for free.
...
If you already know how IFTTT works, you can [skip ahead](#1-plan-your-integration).
...
![Service page example](https://web-assets.ifttt.com/builds/assets/service_page-DlYWm8z5.png "Service page")
...
![Applet example](https://web-assets.ifttt.com/builds/assets/applet_example-BbJzDlZe.png "Applet example")
...
![Applet components](https://web-assets.ifttt.com/builds/assets/applet_components-BvvdkoAH.png "Applet components")
...
***Pro tip: Learn from other similar services. If you need help figuring out what might be most useful to your users, you can browse our services catalog for similar products and use the triggers, queries, and actions they support as things to consider.***
...
![Architecture diagram](https://web-assets.ifttt.com/builds/assets/architecture_diagram-a7q0SLU9.png "Architecture diagram")
...
***Note: Your invitees must first have their own IFTTT account in order to preview your service and test it with Applets. If they don't yet have an IFTTT account, they can create one for free from the Invite URL.***
...
![Philips hue landing page](https://web-assets.ifttt.com/builds/assets/landing_page_hue-CvxBlmzt.png "Landing page hue")

### Works with IFTTT badges

Make sure to tell the world that you work with IFTTT on your packaging, website, digital properties, and trade show displays. Use badges in marketing material to promote your integrations, too. You may place these next to other _Works with_ or _Download on_ badges like Google Play, App Store, Google Assistant, and Amazon Alexa.

![Example Works with IFTTT badges](https://web-assets.ifttt.com/builds/assets/example_badges-DTV_Kii7.jpg "Example badges")

On request, we can also create customized _Works with IFTTT_ badges that feature your service icon or logo.

![Custom Works with IFTTT badges](https://web-assets.ifttt.com/builds/assets/custom_badges-W_c48GK-.jpg "Custom badges")
...
![Social media example](https://web-assets.ifttt.com/builds/assets/social_media_example-GAjJBY6R.png "Social media example")
...
![Email example](https://web-assets.ifttt.com/builds/assets/litter_robot_email-CVYin9Mt.png "Litter robot email")
