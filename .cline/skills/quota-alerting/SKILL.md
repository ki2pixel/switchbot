...
- Tests : `tests/test_dashboard_routes.py` (scénarios quota + polling adaptatif lignes 157-217, 643-675).
...
4. **Tests** :
 ...
 - **Polling adaptatif** : tests dans `test_dashboard_routes.py` couvrent la persistance UI (`test_update_settings_persists_adaptive_polling`).
